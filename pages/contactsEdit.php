	...
	<form action="?action=contactsEdit" method="post" class="form-horizontal">
		<fieldset class="well">
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactName" id="contactName" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactName ?>" size="25" /></div>
			</div>
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactSurname" id="contactSurname" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactSurname ?>" size="25" /></div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactAddress" id="contactAddress" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactAddress ?>" size="25" /></div>
			</div>
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactCity" id="contactCity" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactCity ?>" size="25" /></div>
			</div>
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactPostcode" id="contactPostcode" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactPostcode ?>" size="10" /></div>
			</div>
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactCountry" id="contactCountry" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactCountry ?>" size="25" /></div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls"><input type="text" name="contactTelephone" id="contactTelephone" value="<?= Context::getInstance()->configurationManager->getConfiguration()->contactTelephone ?>" size="25" /></div>
			</div>
			<div class="control-group">
