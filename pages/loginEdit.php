<div class="login ">
	...
	<form action="?action=loginEdit" method="post" class="form-horizontal">
		<fieldset class="well">
			...
			<div class="control-group">
				<div class="control-label"><label id="password-lbl" for="password" class=" required"><?= Context::getInstance()->translator->translate("login.newPassword") ?><span class="star">&#160;*</span></label></div>
			...
			<div class="control-group">
				<div class="control-label"><label id="confirm-password-lbl" for="confirmPassword" class=" required"><?= Context::getInstance()->translator->translate("login.confirmPassword") ?><span class="star">&#160;*</span></label></div>
