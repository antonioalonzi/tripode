<div class="contact">
	...
	<div id="slide-contact" class="accordion">
		<dl class="contact-address dl-horizontal">
			<dt><span class="jicons-icons" ><img src="img/icons/address.png" alt="<?= Context::getInstance()->translationService->translate("contacts.address") ?>: " title="<?= Context::getInstance()->translationService->translate("contacts.address") ?>: " /></span></dt>
			...
			<dt><span class="jicons-icons" ><img src="img/icons/telephone.png" alt="<?= Context::getInstance()->translationService->translate("contacts.telephone") ?>: " title="<?= Context::getInstance()->translationService->translate("contacts.telephone") ?>: "/></span></dt>
			<dd><span class="contact-telephone"><?= Context::getInstance()->configurationService->getConfiguration()->contactTelephone ?></span></dd>
			
			<dt><span class="jicons-icons" ><img src="img/icons/mobile.png" alt="<?= Context::getInstance()->translationService->translate("contacts.mobile") ?>: " title="<?= Context::getInstance()->translationService->translate("contacts.mobile") ?>: " /></span></dt>
